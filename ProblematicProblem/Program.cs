...
namespace ProblematicProblem
{
    class Program
    {
        ...
        static List<string> activities = new List<string>() { "Movies", "Paintball",
                "Bowling", "Lazer Tag", "LAN Party", "Hiking",
        ...
        static void Main(string[] args)
        {
            ...
            int userAge = int.Parse(Console.ReadLine());//string readline
            ...
            if (seeList)
            {
                foreach (string activity in activities)
                {
                    ...
                    Thread.Sleep(50); // Thread.Sleep= suspend or pause current
                }                    // thread execution by passing time in milliseconds or TimeSpan
                Console.WriteLine();// 250 set at, try 500 see what it does, think 500 slowed it down?
                                    // 150 increased the speed
